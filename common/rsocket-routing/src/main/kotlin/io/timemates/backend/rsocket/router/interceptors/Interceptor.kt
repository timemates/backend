package io.timemates.backend.rsocket.router.interceptors
...
public sealed interface Preprocessor<T, R> : Interceptor<T, R> {
     ...
     *
     * @param Payload The type of payload to be processed.
     *
    ...
    public fun interface CoroutineContext : Preprocessor<Payload, CoroutineContext> {
        public suspend fun intercept(input: Payload): kotlin.coroutines.CoroutineContext
    }

    /**
     * This interface represents a modifier that can be used to preprocess payloads.
     *
     * @param Payload the type of payload that this modifier can process.
     * @see Preprocessor
     */
