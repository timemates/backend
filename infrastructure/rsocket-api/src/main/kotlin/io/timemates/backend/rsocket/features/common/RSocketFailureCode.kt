package io.timemates.backend.rsocket.features.common
...
value class RSocketFailureCode(val code: Int) {
    companion object {
        ...
        /**
         * Represents unimplemented state of a method.
         */
        val UNIMPLEMENTED = RSocketFailureCode(HttpStatusCode.NotImplemented.value)
        ...
        val FORBIDDEN = RSocketFailureCode(HttpStatusCode.Forbidden.value)
