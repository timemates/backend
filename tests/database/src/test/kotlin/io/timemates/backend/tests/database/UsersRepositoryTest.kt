...
import io.timemates.backend.integrations.postgresql.repositories.DbUsersRepository
...
class UsersRepositoryTest {
    ...
    private val usersRepository = DbUsersRepository(DbUsersDatabaseDataSource(database))
