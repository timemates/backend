...
import org.tomadoro.backend.repositories.SchedulesRepository
import java.util.concurrent.ConcurrentHashMap
import kotlin.time.Duration
import org.tomadoro.backend.repositories.SchedulesRepository as Contract

class MockedSchedulesRepository(private val scope: CoroutineScope) : Contract {
    ...
    override suspend fun <K : Any> single(key: K, action: suspend SchedulesRepository.() -> Unit) =
