 ...
 *
 * @param Key the type of key used to identify the FSM state
 ...
 */
public interface StateStorage<Key, FsmState : State<Event>, Event> {
     ...
     */
    public suspend fun save(key: Key, state: FsmState)
     ...
     */
    public suspend fun load(key: Key): FsmState?
}