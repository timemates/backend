package org.tomadoro.backend.application.results.serializer

import kotlinx.serialization.modules.SerializersModule
import kotlinx.serialization.modules.polymorphic
import kotlinx.serialization.modules.subclass
import org.tomadoro.backend.application.results.*
...
internal val ResultsSerializersModule: SerializersModule = SerializersModule {
    ...
    polymorphic(KickTimerUserResult::class) {
    ...
    polymorphic(GetMembersResult::class) {
        subclass(GetMembersResult.Success::class)
